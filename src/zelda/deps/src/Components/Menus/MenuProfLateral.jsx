        ...
        return (
            <div className="menu-prof">
                <Dropdown.Menu show className="MenuProfLateral">
                    ...
                    <Dropdown.Item eventKey="7" href={window.viewGradesUrl}>
                        {gettext("View Grades")}
                    </Dropdown.Item>
                    <Dropdown.Header>{gettext("Actions")}</Dropdown.Header>
                    <Dropdown.Item eventKey="6" href={window.viewShiftStatusUrl}>{gettext("Shift Statuses")}</Dropdown.Item>
                    <Dropdown.Item eventKey="5" href={window.uploadGradesUrl}>{gettext("Upload Grades")}</Dropdown.Item>
