...
class Schedule extends React.Component {
    ...
    handleDatesRender(event) {
        ...
        this.props.classes.map(_class => {
            ...
            if (classDay.isBetween(this.firstSemesterBeginDate, this.firstSemesterEndDate) && _class.semester === "1" || classDay.isBetween(this.secondSemesterBeginDate, this.secondSemesterEndDate) && _class.semester === "2") {
                events.push({
                    id: _class.id,
